...
resulting S distribution. The kept set is agg.KEPT_MEASURES (engage, suppress,
dial_rank, temporal_control, coverage, layer_targeting; dial_resolution was
dropped from S on 2026-08-08). suppress reuses the engage dprime kernel; layer_targeting needs
