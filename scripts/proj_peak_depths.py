#!/usr/bin/env python3
"""Diagnostic (new, non-invasive): find the PROJECTION channel's peak DEPTHS for
the two fixed-depth battery views, to set PROJ_F_POS and PROJ_F_LOC by analogy to
the existing COS_F_POS/COS_F_LOC and RN_F_POS/RN_F_LOC constants.
